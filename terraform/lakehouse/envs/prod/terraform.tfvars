...
curated_iceberg_dataset_id = "curated_iceberg_prod"
...
raw_external_tables = {
  sample_ext = {
    ...
    source_uris   = ["gs://lakehouse-486419-raw-prod/domain=sales/dataset=sample/*"]
  }
}

dataform_repository_name          = "lakehouse-prod-dataform"
...
dataform_sa_email      = "sa-dataform-prod@lakehouse-486419.iam.gserviceaccount.com"
